...
warnpatterns = [
    ...
    {'category': 'C/C++', 'severity': severity.HIGH, 'members': [],
    ...
    {'category': 'C/C++', 'severity': severity.MEDIUM, 'members': [],
    ...
    {'category': 'gcc', 'severity': severity.MEDIUM, 'members': [], 'option': '',
     ...
     'patterns': [
         r".*: warning: command line option "".+"" is valid for C\+\+\/ObjC\+\+ but not for C"]},
    {'category': 'C/C++', 'severity': severity.MEDIUM, 'members': [], 'option': '',
    ...
    for i in warnpatterns:
        if len(i['members']) == 0 and i['severity'] != severity.SKIP:
            if tablestarted == False:
                tablestarted = True
                begintable(['Fixed warnings',
                            'No more occurences. Please consider turning these in to errors if possible, before they are reintroduced in to the build'],
                           'blue')
