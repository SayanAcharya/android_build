...
def BuildVerityMetadata(image_size, verity_metadata_path, root_hash, salt,
    ...
    print cmd
    runcmd = ["system/extras/verity/build_verity_metadata.py", image_size, verity_metadata_path,
              root_hash, salt, block_device, signer_path, key];
...
def BuildImage(in_dir, prop_dict, out_file, target_out=None):
    ...
    if fs_type.startswith("ext"):
        ...
        if "squashfs_disable_4k_align" in prop_dict and prop_dict.get(
                "squashfs_disable_4k_align") == "true":
